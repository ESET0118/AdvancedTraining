...
export default function ProfileSettingsPage() {
  ...
  return (
    <div className="flex bg-gray-50 dark:bg-gray-900 transition-colors duration-300 mt-10">
      {/* Sidebar */}
      <Sidebar />
      ...
      <div className="flex-1 flex flex-col" style={{ marginLeft: "15rem" }}>
        ...
        {/* Page content */}
        <main
          className="flex-1 flex flex-col items-center overflow-y-auto px-4"
          style={{ marginTop: "4rem", paddingBottom: "2rem" }} // reserve space for header
        >
